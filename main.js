...
app.controller('DashController', ['$scope', '$window', 'sources', 'contributors', 'dashifTestVectors', function ($scope, $window, sources, contributors, dashifTestVectors) {
    ...
    $scope.doLoad = function () {
        ...
        console.log('initBitrate', $scope.initialVideoBitrate);
    ...
    function logger(){
	    ...
	    'Throughput':$scope.player.getAverageThroughput("video"),
            'audioLiveLatency':$scope.audioLiveLatency,
            'audioPlaybackRate':$scope.audioPlaybackRate};
            console.log(data);
            fetch('http://127.0.0.1:13000/data',{method:'POST',Headers:{Accept:'application.json','Content-Type':'application/json'},body:JSON.stringify(data)}).then(res=>console.log("data posted")).catch(res=>console.log("please start the logging server"));
    }
