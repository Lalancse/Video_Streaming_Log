...
if (config.HasClientRequestedIndependentOption(kTBBR, perspective) || ((GetQuicReloadableFlag(quic_allow_client_enabled_bbr_v2) &&config.HasClientRequestedIndependentOption(kB2ON, perspective))) || (config.HasClientRequestedIndependentOption(kRENO, perspective)) || ((config.HasClientRequestedIndependentOption(kBYTE, perspective) || (GetQuicReloadableFlag(quic_default_to_bbr) && config.HasClientRequestedIndependentOption(kQBIC, perspective))))  ) {  
