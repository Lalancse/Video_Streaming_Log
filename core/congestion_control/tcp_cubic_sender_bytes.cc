...
void TcpCubicSenderBytes::SetCongestionWindowFromBandwidthAndRtt(
  ...
  congestion_window_ =
   ...
   std::cout << "The current date and time is: " << date_time <<"\n";
  std::cout<<" SetCongestionWindowFromBandwidthAndRtt " <<congestion_window_<<"\n";
}
...
void TcpCubicSenderBytes::OnPacketLost(QuicPacketNumber packet_number,
                                       ...
                                       QuicByteCount prior_in_flight) {
   //Print Number of loss Packet
   std::cout<<"Number of packet lost: "<<lost_bytes<<"\n";
 ...
 char* date_time = ctime(&now);
 std::cout << "The current date and time is: " << date_time <<"\n";
 std::cout<<"Incoming loss; congestion window: "<<congestion_window_<<"\n";
}
...
void TcpCubicSenderBytes::MaybeIncreaseCwnd(
  ...
  if (reno_) {
    ...
    // Modify Code congestion window
   // current date and time on the current system
   time_t now = time(0);
   // convert now to string form
   char* date_time = ctime(&now);
   std::cout << "The current date and time is: " << date_time <<"\n";
    std::cout<<"Reno; congestion window: "<<congestion_window_<<"\n";
  } else {
   ...
   char* date_time = ctime(&now);
   std::cout << "The current date and time is: " << date_time <<"\n";
    std::cout<<"Cubic; congestion window: "<<congestion_window_<<"\n";
  }
}
